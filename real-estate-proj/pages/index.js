...
export default function Home({ propertyForSale, propertyForRent }) {
	...
	const rentProperties = propertyForRent.map(rentProp => (
		<Property key={rentProp.id} property={rentProp} />
	));
	...
	return (
		<Box>
			...
			<Flex flexWrap="wrap" >{rentProperties}</Flex>
			...
			<Flex flexWrap="wrap" >{saleProperties}</Flex>
		</Box>
	);
}

// Next.js allows the props object returned from this function 
// to be accessed directly as props in components above
