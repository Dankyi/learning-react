...
export default function Form() {
    ...
    function handleSubmit(event) {
        // This will prevent refreshing of the page after submission  
        // hence retains all the form data passed in by the user.
        // Also it prevents the data from being passed into the url 
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            {/* Form submission */}
            {/* Either use this or the one below it */}
            {/* <input type="submit" value="SUBMIT APPLICATION"/> */}

            {/* In html5 button is used instead and its default type is 
            submit so no need to explicitly insert type="submit". If you don't
            want to make it a submit type then change its type to button*/}
