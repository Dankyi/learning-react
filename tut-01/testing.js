// // const nums = [1, 2, 3];
// // const sqrd = nums.map((num) => num * num);
// // // console.log(sqrd);

// // const fruits = ["pear", "apple", "lime"];
// // const cap = fruits.map(fruit => fruit[0].toUpperCase() + fruit.slice(1));
// // // console.log(cap);

// // const names = ["Kofi", "Kwesi", "Kojo"];
// // const str = names.map(name => `<p>${name}</p>`);
// // // console.log(str);
...
// // const data = fruitsData.map((fruit) => fruit);
// // // console.log(data);
...
// const memeUrl = memesData.data.memes[0].url;
// console.log(memeUrl);
...
// function subtract() {
//     // setCount(count - 1);
//     // Above works but proper way of doing it (best practice) is using callback
//     setCount(function(oldValue) { // oldValue / previous value of count
//         return oldValue - 1;
//     });
...
// function addItem() {
//     // Wrong approach
//     // setThingsArray(prevState => prevState.push(`Thing ${prevState.length + 1}`));
    
//     // Correct approach
//     // [...prevState] = An array of everything that used to be in there 
//     // followed by the next item to add to the list
//     // NB: If you use a one liner as shown below no "return" is needed as its only
//     // used when you introduce a {} after => 
...
//         // Get all the properties that used to be in there before
//         // and then change the value of isFavorite. NB: You can change
//         // other properties too but focus here is to toggle favorite
//         return {
//             ...prevState, // Previous properties/state
//             isFavorite: !prevState // Changing only the isFavorite property
//         }

//         // // NB: The above return statement can be interpreted as follows which works
//         // // just like above but for simplicity the above is recommended (best practice)
//         // return {
//         //     firstname: "Bob",
//         //     lastname: "McNeil",
//         //     phone: "0748461462",
...
//     // NB: For objects, to put it all on one line without using 
//     // "return" keyword, wrap in brackets like this:
...
// // NOTE: "onClick={}" ONLY WORKS ON NATIVE HTML ELEMENTS (e.g. img, h1, div etc.) 
// // AND NOT ON MANUALLY CREATED COMPONENTS (e.g. <Header />, <Contact /> etc).
// // SO IN ORDER TO USE IT IN THERE, YOU PASS IT AS AN ARGUMENT/PROP AND ACCESS 
// // IT IN THE COMPONENT FILE SEE EXAMPLE BELOW:

// // In App.js
// function App() {
//     function toggleFavorite() {
//         // Toggles favorite code
//     }

//     return (
//         <div>
//             {/* Pass the toggle function as argument/prop here*/}
//             <Star onStarIconClicked={toggleFavorite}/> 
//         </div>
//     );
// }
...
//     return (
//         <div>
//             {/* Access the passed function here in the native html element*/}
//             <img onClick={props.onStarIconClicked}></img>
//         </div>
//     );
// }
...
// In React properties can be passed down from the top of the  
// node or from the root node of a tree and not from one child
// to the adjacent child or up the tree. Example is as follows:

// We have a tree: App.js (root node), Header.js and Body.js (child nodes)
// We want to pass user state which exists in the Header component/child node
// to the Body child component. Below are the original files
...
// // FINAL SOLUTION TO THE PROBLEM USING INHERITANCE VIA PROPS 
// export default function App() {
//     const [ user, setUser ] = React.useState("Joe");
...
// // CONDITIONAL RENDERING - ARRAY EXAMPLE
...
//     //         h1Text = <h1>You have {messages.length} unread message!</h1>;
//     //     } else {
//     //         h1Text = <h1>You have {messages.length} unread messages!</h1>;
//     //     }
//     // } else if (messages.length === 0) {
//     //     h1Text = <h1>You're all caught up!</h1>;
//     // }
...
//                 <h1>You have {messages.length} unread message{
